select s.schoolid as Campus_Id
      ...
      ,TLAST as TLName
      ,TEMAIL as Email
      ,SUSERNAME || (case when rn = 0 then null else rn end) as Desired_Student_Username
      ,SPASSWORD as Desired_Student_Password
      ,sgrade || ': ' || team as Desired_Class_Identifier
...
left outer join students s on SID = s.student_number

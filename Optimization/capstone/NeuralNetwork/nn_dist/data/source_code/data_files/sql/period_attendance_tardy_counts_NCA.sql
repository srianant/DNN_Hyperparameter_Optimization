select lastfirst 
      ...
      ,t_jun
from
     (select decode(grouping(lastfirst),1,'sum',lastfirst) lastfirst
            ,decode(grouping(grade_level),1,'sum',grade_level) as grade_level
            ,decode(grouping(gender),1,'sum',gender) gender
            ,decode(grouping(course),1,'sum',course) course
